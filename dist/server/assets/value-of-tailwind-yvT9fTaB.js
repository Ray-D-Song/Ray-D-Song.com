...
<span class="line"><span style="${ssrRenderStyle({ "color": "#797593", "--shiki-dark": "#9ABDF5" })}">  }</span></span>
<span class="line"><span style="${ssrRenderStyle({ "color": "#797593", "--shiki-dark": "#9ABDF5" })}">}</span></span>
<span class="line"></span></code></pre><p>在 tailwind 上, 适配 768px 宽度的设备, 你只要在样式前加入 <code>md</code> 前缀即可.</p><pre class="shiki shiki-themes rose-pine-dawn tokyo-night" style="${ssrRenderStyle({ "background-color": "#faf4ed", "--shiki-dark-bg": "#1a1b26", "color": "#575279", "--shiki-dark": "#a9b1d6" })}" tabindex="0"><div class="copy-container"><div class="lang-symbol">html</div><img${ssrRenderAttr("src", _imports_0)} class="copy-icon" data-code="&lt;body class=&quot;md:w-4/5&quot;&gt;
...
<span class="line"></span></code></pre><h1>利好无设计开发</h1><p>个人或者小团队开发产品, 没有专业的设计师出图, 写组件相当痛苦. 例如 box-shadow 属性, button、card、modal, 每个都需要不一样的 shadow 样式. 在自己编写的时候经常要重复修改多次来达到一个比较好的效果, twc 提供了 7 个不同规格的选项, 都是泛用性非常高的选择. 现在你要写一个现代化外观的按钮只需要<code>class=&quot;shadow-md rounded-lg&quot;</code>就行了.</p><h1>新的组件模式</h1><p>tailwind 还有个衍生品, Headless UI. 将组件的功能和样式彻底分离. 很多时候组件的功能是相同的 , 但是需要不同的样式, 有时候样子一样的组件却需要完全不同的 api. Headless 就是为了解决这个问题.</p><blockquote><p>NuxtLab UI 就是一个无头tailwind组件库, 闲得蛋疼可以看看, 代码很干净.</p></blockquote><h1>class 也太特么长了</h1><p>这是一个由 tailwind 编写的 checkbox, 做了动效和深色适配.</p><pre class="shiki shiki-themes rose-pine-dawn tokyo-night" style="${ssrRenderStyle({ "background-color": "#faf4ed", "--shiki-dark-bg": "#1a1b26", "color": "#575279", "--shiki-dark": "#a9b1d6" })}" tabindex="0"><div class="copy-container"><div class="lang-symbol">html</div><img${ssrRenderAttr("src", _imports_0)} class="copy-icon" data-code="&lt;input type=&quot;checkbox&quot; class=&quot;w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 rounded focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600&quot;/&gt;
...
<span class="line"></span></code></pre><p>看到这个长度是不是蚌埠住了. 没关系 tailwind 有<code>@layer</code>和<code>@apply</code>, 你可以像组织传统 css 一样去组织 tailwind, 封装自己的样式组件.</p><pre class="shiki shiki-themes rose-pine-dawn tokyo-night" style="${ssrRenderStyle({ "background-color": "#faf4ed", "--shiki-dark-bg": "#1a1b26", "color": "#575279", "--shiki-dark": "#a9b1d6" })}" tabindex="0"><div class="copy-container"><div class="lang-symbol">css</div><img${ssrRenderAttr("src", _imports_0)} class="copy-icon" data-code="@layer components {
  .checkbox {
    @apply
    w-4
    h-4
