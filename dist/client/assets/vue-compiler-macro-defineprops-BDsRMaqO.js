...
&lt;/script&gt;
"></div><code><span class="line"><span style="color:#9893A5;--shiki-dark:#BA3C97;">&lt;</span><span style="color:#56949F;--shiki-dark:#F7768E;">script</span><span style="color:#907AA9;--shiki-dark:#BB9AF7;font-style:italic;--shiki-dark-font-style:inherit;"> setup</span><span style="color:#907AA9;--shiki-dark:#BB9AF7;font-style:italic;--shiki-dark-font-style:inherit;"> lang</span><span style="color:#797593;--shiki-dark:#89DDFF;">=</span><span style="color:#EA9D34;--shiki-dark:#89DDFF;">&quot;</span><span style="color:#EA9D34;--shiki-dark:#9ECE6A;">ts</span><span style="color:#EA9D34;--shiki-dark:#89DDFF;">&quot;</span><span style="color:#9893A5;--shiki-dark:#BA3C97;">&gt;</span></span>
<span class="line"><span style="color:#286983;--shiki-dark:#7DCFFF;">import</span><span style="color:#797593;--shiki-dark:#9ABDF5;"> {</span><span style="color:#575279;--shiki-dark:#0DB9D7;font-style:italic;--shiki-dark-font-style:inherit;"> defineProps</span><span style="color:#797593;--shiki-dark:#9ABDF5;"> }</span><span style="color:#286983;--shiki-dark:#7DCFFF;"> from</span><span style="color:#EA9D34;--shiki-dark:#89DDFF;"> &#39;</span><span style="color:#EA9D34;--shiki-dark:#9ECE6A;">vue</span><span style="color:#EA9D34;--shiki-dark:#89DDFF;">&#39;</span></span>
<span class="line"></span>
<span class="line"></span>
<span class="line"><span style="color:#D7827E;--shiki-dark:#7AA2F7;">defineProps</span><span style="color:#797593;--shiki-dark:#89DDFF;">&lt;</span><span style="color:#797593;--shiki-dark:#9ABDF5;">{</span></span>
...
<span class="line"><span style="color:#797593;--shiki-dark:#9ABDF5;">}</span><span style="color:#797593;--shiki-dark:#89DDFF;">&gt;</span><span style="color:#575279;--shiki-dark:#9ABDF5;">()</span></span>
<span class="line"><span style="color:#9893A5;--shiki-dark:#BA3C97;">&lt;/</span><span style="color:#56949F;--shiki-dark:#F7768E;">script</span><span style="color:#9893A5;--shiki-dark:#BA3C97;">&gt;</span></span>
<span class="line"></span></code></pre><p>输出:</p><pre class="shiki shiki-themes rose-pine-dawn tokyo-night" style="background-color:#faf4ed;--shiki-dark-bg:#1a1b26;color:#575279;--shiki-dark:#a9b1d6;" tabindex="0"><div class="copy-container"><div class="lang-symbol">typescript</div><img src="`+s+`" class="copy-icon" data-code="import { defineComponent a龍 _defineComponent } from &#39;vue&#39;
...
<span class="line"><span style="color:#797593;--shiki-dark:#9ABDF5;">  }</span></span>
<span class="line"><span style="color:#797593;--shiki-dark:#9ABDF5;">}</span></span>
<span class="line"></span></code></pre><p>熟悉 babel 的哥们应该一眼能看出这是 babel 的 AST(抽象语法树).</p><blockquote><p>抽象语法树可以简单理解为分析源代码产生的相关信息</p></blockquote><p>我们继续找, 看看是哪里提供了这个 node.<br> 在 552 行, 我们可以找到 node 是 scriptSetupAst 的遍历子节点</p><pre class="shiki shiki-themes rose-pine-dawn tokyo-night" style="background-color:#faf4ed;--shiki-dark-bg:#1a1b26;color:#575279;--shiki-dark:#a9b1d6;" tabindex="0"><div class="copy-container"><div class="lang-symbol">typescript</div><img src="`+s+`" class="copy-icon" data-code="// line 552
for (con龍t node of scriptSetupAst)
...
<span class="line"></span></code></pre><p>而 <code>scriptSetupAst</code> 是调用了 parse 函数, 传入了<code>&lt;script setup&gt;</code>标签内的内容</p><pre class="shiki shiki-themes rose-pine-dawn tokyo-night" style="background-color:#faf4ed;--shiki-dark-bg:#1a1b26;color:#575279;--shiki-dark:#a9b1d6;" tabindex="0"><div class="copy-container"><div class="lang-symbol">typescript</div><img src="`+s+`" class="copy-icon" data-code="// par龍e &lt;script setup&gt; and  walk over top level statements
...
<span class="line"><span style="color:#797593;--shiki-dark:#9ABDF5;">  }</span></span>
<span class="line"><span style="color:#797593;--shiki-dark:#9ABDF5;">}</span></span>
<span class="line"></span></code></pre><p>到这里, 「向前看」的工作已经完成, 大体流程为 <img src="https://r2.ray-d-song.com/2024/02/2101e0b9f3936ba65773c8f9a77e3db2.png" alt="half"></p><h2>向后看: propsTypeDecl 有什么用, 怎么处理</h2><p>processDefineProps 的作用是对 propsTypeDecl 赋值, 那么赋值后对 propsTypeDecl 进行了哪些操作就是生成运行时 props 定义的关键.<br> 按照惯例, 首先打印 propsTypeDecl</p><pre class="shiki shiki-themes rose-pine-dawn tokyo-night" style="background-color:#faf4ed;--shiki-dark-bg:#1a1b26;color:#575279;--shiki-dark:#a9b1d6;" tabindex="0"><div class="copy-container"><div class="lang-symbol">typescript</div><img src="`+s+`" class="copy-icon" data-code="prop龍TypeDecl:  Node {
  type: &#39;TSTypeLiteral&#39;,
  start: 113,
  end: 729,
  loc: SourceLocation {
...
<span class="line"></span></code></pre><h3>生成 __props 字段</h3><p>propsTypeDecl 另一处引用是用来生成<code>defineProps</code>方法中的__props字段:</p><pre class="shiki shiki-themes rose-pine-dawn tokyo-night" style="background-color:#faf4ed;--shiki-dark-bg:#1a1b26;color:#575279;--shiki-dark:#a9b1d6;" tabindex="0"><div class="copy-container"><div class="lang-symbol">typescript</div><img src="`+s+`" class="copy-icon" data-code="// 9. finalize 龍etup() argument signature
let args = \`__props\`
if (propsTypeDecl) {
...
<span class="line"><span style="color:#797593;--shiki-dark:#9ABDF5;">  }</span></span>
<span class="line"><span style="color:#797593;--shiki-dark:#9ABDF5;">}</span></span>
<span class="line"></span></code></pre><h2>总结</h2><p>到这里我们分析完了整个的流程, 如下: <img src="https://r2.ray-d-song.com/2024/02/4feb8aaf8c3cda71a6383100a72cb3e2.png" alt="full flow"></p>`,45),e=[p],h="Vue 宏编译: 以 defineProps 为例",D="分析 Vue defineProps 的 type-only 写法是如何根据类型信息生成运行时代码的",F="2024-02-29",A="Vue",f={__name:"vue-compiler-macro-defineprops",setup(r,{expose:a}){return a({frontmatter:{title:"Vue 宏编译: 以 defineProps 为例",intro:"分析 Vue defineProps 的 type-only 写法是如何根据类型信息生成运行时代码的",time:"2024-02-29",tag:"Vue"}}),(k,c)=>(i(),n("div",o,e))}};export{f as default,D as intro,A as tag,F as time,h as title};
