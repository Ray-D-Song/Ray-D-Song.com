...
"></div><code><span class="line"><span style="color:#286983;--shiki-dark:#7DCFFF;">import</span><span style="color:#797593;--shiki-dark:#9ABDF5;"> {</span><span style="color:#575279;--shiki-dark:#0DB9D7;font-style:italic;--shiki-dark-font-style:inherit;"> defineProps</span><span style="color:#797593;--shiki-dark:#9ABDF5;"> }</span><span style="color:#286983;--shiki-dark:#7DCFFF;"> from</span><span style="color:#EA9D34;--shiki-dark:#89DDFF;"> &#39;</span><span style="color:#EA9D34;--shiki-dark:#9ECE6A;">vue</span><span style="color:#EA9D34;--shiki-dark:#89DDFF;">&#39;</span></span>
...
<span class="line"><span style="color:#797593;--shiki-dark:#9ABDF5;">  }</span></span>
<span class="line"><span style="color:#797593;--shiki-dark:#9ABDF5;">}</span></span>
<span class="line"></span></code></pre><h2>总结</h2><p>到这里我们分析完了整个的流程, 如下: <img src="https://r2.ray-d-song.com/2024/02/4feb8aaf8c3cda71a6383100a72cb3e2.png" alt="full flow"></p>`,44),e=[p],h="Vue 宏编译: 以 defineProps 为例",D="分析 Vue defineProps 的 type-only 写法是如何根据类型信息生成运行时代码的",F="2024-2-29",A="Vue",f={__name:"vue-compiler-macro-defineprops",setup(r,{expose:a}){return a({frontmatter:{title:"Vue 宏编译: 以 defineProps 为例",intro:"分析 Vue defineProps 的 type-only 写法是如何根据类型信息生成运行时代码的",time:"2024-2-29",tag:"Vue"}}),(k,c)=>(i(),n("div",o,e))}};export{f as default,D as intro,A as tag,F as time,h as title};
